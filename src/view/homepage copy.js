...
const translations = {
  ...
  zh: {
    ...
    multiModel: {
      title: "多模型融合",
      desc: "结合ResNet50、AlexNet、vgg6、ViT(监督学习);Autoencoder、Variational Autoencode、Vit Anomaly(无监督学习)等7种深度学习模型，实现特定领域的视觉分析"
    },
    smartSegmentation: {
      title: "智能分割",
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="relative max-w-6xl mx-auto px-4 pt-16 md:pt-20 pb-12 md:pb-16">
            <h1 className="text-2xl md:text-4xl font-bold mb-4 md:mb-6 bg-clip-text text-transparent bg-gradient-to-r from-gray-900 to-gray-600">
              {t.title}
            </h1>
